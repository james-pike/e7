        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {TEAM_MEMBERS.map((member) => (
            ...
            >
              ...
              <div class="bg-gradient-to-r from-clay-50/50 to-sage-50/50 py-3 text-center">
                <a
                  href="#"
                  class="text-clay-600 hover:text-clay-800 text-sm font-medium transition-colors"
                >
                  Learn More
                </a>
              </div>
