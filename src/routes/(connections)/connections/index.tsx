                  ...
                  <div class="flex flex-col items-center p-3 pt-2">
                    <div class="relative w-full flex items-center justify-center mb-2 group/link">
                      ...
                      >
                        ...
                        <svg
                          class="w-5 h-5 text-primary-600 dark:text-primary-400 group-hover/link:text-secondary-800 dark:group-hover/link:text-secondary-800 transition-all duration-200 ease-in-out"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
