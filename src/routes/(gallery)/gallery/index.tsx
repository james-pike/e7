...
export default component$(() => {
  ...
  return (
    <section class="relative overflow-hidden py-16 md:py-20">
      ...
      {/* Gradient background */}
      <div
        class="absolute inset-0 bg-gradient-to-br from-secondary-50/50 via-primary-50/50 to-tertiary-50/50 dark:from-secondary-900/50 dark:via-primary-900/50 dark:to-tertiary-900/50"
        aria-hidden="true"
      ></div>
