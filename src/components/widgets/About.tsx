    ...
    <div class="bg-white dark:bg-gray-900">
      <main class="isolate">
        ...
        <section class="relative overflow-hidden py-16 md:py-20">
          ...
          {/* Gradient background */}
          <div class="absolute inset-0 bg-gradient-to-br from-clay-50/50 via-white to-sage-50/50 dark:from-clay-900/50 dark:via-gray-900 dark:to-sage-900/50" aria-hidden="true"></div>
        ...
        <section class="relative overflow-hidden py-16 md:py-20">
          <div class="relative isolate overflow-hidden bg-gradient-to-r from-clay-50 to-sage-50 dark:from-clay-900 dark:to-sage-900 px-6 py-24 text-center sm:rounded-3xl sm:px-16 border-2 border-clay-100 dark:border-clay-700">
            ...
            <div class="absolute top-0 right-0 w-24 h-24 bg-clay-300/20 rounded-full blur-xl animate-float" aria-hidden="true"></div>
          </div>
        </section>
      </main>
    </div>
