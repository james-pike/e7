      ...
      class={`sticky top-0 z-40 flex-none bg-gradient-to-br from-sage-50/50 via-earth-50/30 to-clay-50/50 mx-auto transition-[opacity] ease-in-out ${
        isLandingPage
          ? store.isScrolling
            ...
            : "texture"
          : "bg-sage-100 border-y md:border-b border-sage-200" // Always bg-background when not on landing page
      }`}
      window:onScroll$={() => {
...
</div>            {/* <div  class="inline-flex hidden sm:block justify-between items-center py-1 px-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
