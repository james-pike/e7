...
import MenuModal from "./MenuModal";export default component$(() => {
      ...
      <div class="relative text-default py-2 md:p-1 px-2 md:px-6 mx-auto w-full md:flex md:justify-between max-w-7xl">
        <div class="mr-auto rtl:mr-0 rtl:ml-auto flex justify-between">
          <a class="flex items-center" href="/">
            ...
            {/* <span class="ml-2 text-xl font-bold font-serif text-primary-600 xdxd">earthen vessels</span> */}
          </a>      <div class="flex items-center md:hidden gap-1">
        <MenuModal />
      </div>
    </div>
    <nav
...
py-2  `}
                        >
                          {items.map(({ text: text2, href: href2 }, key2) => {
                            ...
                            const isLast = key2 === items.length - 1;                        return (
                          <li key={key2}>
                            <a
                              class={`hover:bg-muted hover:text-secondary-600
