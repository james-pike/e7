...
export default component$(() => {
  ...
  const faqs = [
    ...
    { id: 5, question: "Do you host private events?", answer: "Yes, we host private workshops and team events. Our next open house is October 1st." },
        { id: 1, question: "Can I keep what I make?", answer: "Yes! During your workshop, you will create a unique clay piece. It will stay with us until the process of drying and firing in our kiln is completed. We will contact you to pick up your creation once the process is completed - usually 3-4 weeks." },
