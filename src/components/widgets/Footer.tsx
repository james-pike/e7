...
export default component$(() => {
 ...
 {/* Gradient background */}
 <div class="absolute inset-0 bg-gradient-to-br from-primary-100/50 via-tertiary-50/30 to-secondary-50/50" aria-hidden="true"></div>

 <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
 <div class="grid grid-cols-12 gap-4 gap-y-8 sm:gap-8 py-8 md:pt-12 md:pb-0">
 <div class="col-span-12 lg:col-span-4 pr-8">
 <div class="mb-0">
 <Link class="inline-block font-bold text-2xl font-serif" href={"/"}>
