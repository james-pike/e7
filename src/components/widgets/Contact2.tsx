...
export default component$(() => {
  ...
  return (
    <section id="contact" class="relative overflow-hidden py-16 md:py-20">
      ...
      {/* Gradient background */}
      <div class="absolute inset-0 bg-gradient-to-br from-sage-50/50 via-white to-clay-50/50 !important dark:from-sage-900/50 dark:via-gray-900 dark:to-clay-900/50 !important" aria-hidden="true"></div>
      ...
      <div class="absolute top-1/3 right-1/4 w-16 h-16 bg-earth-300/20 rounded-full blur-xl animate-float" style="animation-delay: -4s;" aria-hidden="true"></div>
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div class="space-y-8">
            ...
            {/* Studio Features */}
            <div class="bg-gradient-to-br from-white/90 via-sage-50/30 to-clay-50/30 !important dark:from-gray-800/90 dark:via-sage-900/30 dark:to-clay-900/30 !important backdrop-blur-sm rounded-2xl p-6 border-2 border-clay-100 dark:border-clay-700 shadow-lg">
              ...
              <div class="space-y-4">
                {contactInfo.map((info, index) => (
                  <a
                    ...
                    class="group flex items-start space-x-4 p-4 bg-gradient-to-br from-white/80 via-sage-50/20 to-clay-50/20 !important dark:from-gray-800/80 dark:via-sage-900/20 dark:to-clay-900/20 !important backdrop-blur-sm rounded-xl border-2 border-clay-100 dark:border-clay-700 hover:bg-gradient-to-br hover:from-white/90 hover:via-sage-50/40 hover:to-clay-50/40 hover:shadow-lg transition-all duration-300 hover:border-clay-200"
                  >
