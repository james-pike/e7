...
export default component$((props: Props) => {
  ...
  return (
      ...
      <div class="relative isolate bg-card">
  <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
    <div class="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        <div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-card ring-1 ring-gray-900/10 lg:w-1/2">
          <svg class="absolute inset-0 size-full [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)] stroke-border" aria-hidden="true">
            <defs>
            ...
            <svg x="100%" y="-1" class="overflow-visible fill-background">
