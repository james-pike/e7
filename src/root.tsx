...
<link href="https://fonts.googleapis.com/css2?family=Della+Respira&family=Syne:wght@600&display=swap" rel="stylesheet"></link>
      ...
      <body class="bg-white antialiased">
        ...
        <div class="relative md:border-x mx-auto max-w-7xl overflow-x-hidden"> {/* Added overflow-x-hidden */}
          ...
          <div class="absolute top-80 left-80 w-40 h-40 bg-tertiary-300/30 rounded-full blur-xl animate-float" aria-hidden="true"></div>
